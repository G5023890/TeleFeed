...
enum L10n {
    private static let fallbackStrings: [String: [String: String]] = [
        "en": [
            ...
            "sidebar.subtitle": "Watched feeds and unread counts",
            ...
            "feed.title": "All news",
            "feed.subtitle": "All news from all sources",
        ...
        "ru": [
            ...
            "sidebar.subtitle": "Отслеживаемые источники и счетчики непрочитанных",
            ...
            "feed.subtitle": "Все новости из всех источников",
            "feed.allSources": "Все источники",
